...
try {
  const hasher= await contractHash.methods.hash(c1Move,salt).call();
hasherValue=hasher;
console.log(hasherValue);
console.log("0xc258Ac72a022f45a99827506610Bf430C1709b98");
   ...
   contract= new web3.eth.Contract(contractABI, contractAddress);
      ...
      console.log(`https://shan2001-s.github.io/solLearn/player2.html?id=${contractAddress}`)
...
const node = document.createTextNode(`Before you solve, copy and give link to player2 to play  `);
...
async function stake() {
  ...
  async function solve() {
      ...
      try {
          var j1Move = await contract.methods.getC1Move().call();
          var move =j1Move+1
  console.log('J1 Move:', move);
          const accounts = await web3.eth.getAccounts();
      console.log(accounts);
      const playerAddress = accounts[0];
